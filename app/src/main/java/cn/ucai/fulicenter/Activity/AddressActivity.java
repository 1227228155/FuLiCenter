...
public class AddressActivity extends BaseActivity implements PaymentHandler {
    ...
    public void checkOrder() {
        ...
        if(TextUtils.isEmpty(area)){
            Toast.makeText(AddressActivity.this,"收货地区不能为空",Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void paySuccess() {
        for (String id:ids){
            NetDao.delCart(mContext, Integer.valueOf(id), new OkHttpUtils.OnCompleteListener<MessageBean>() {
                @Override
